...
File intake.
```{r}
profile <- read.table("RN7SK-rRNA-HELA/RN7SK-rRNA-HELA_RN7SK_profile.txt", header = TRUE)
unt_mutation_counts <- read.table("RN7SK-rRNA-HELA/RN7SK-rRNA-HELA_Untreated_RN7SK_mutation_counts.txt", header = TRUE)
mod_mutation_counts <- read.table("RN7SK-rRNA-HELA/RN7SK-rRNA-HELA_Untreated_RN7SK_mutation_counts.txt", header = TRUE)
```
...
write.arff(sars2_u, file = "predict_RN7SK_uracils_amp_NEW.arff")

tx <- readLines("predict_RN7SK_uracils_amp_NEW.arff")
tx_line15 <- gsub(pattern = "'\\?'", replace = "none,pU,Um", x = tx[15])
tx2 <- tx
tx2[15] <- tx_line15
tx3 <- gsub(pattern = "'", replace = "", x = tx2)

writeLines(tx3, "predict_RN7SK_uracils_amp_NEW.arff")
```
...
write.arff(sars2_c, file = "predict_RN7SK_cytosines_amp_NEW.arff")

tx <- readLines("predict_RN7SK_cytosines_amp_NEW.arff")
tx_line15 <- gsub(pattern = "'\\?'", replace = "none,Cm", x = tx[15])
tx2 <- tx
tx2[15] <- tx_line15
tx3 <- gsub(pattern = "'", replace = "", x = tx2)

writeLines(tx3, "predict_RN7SK_cytosines_amp_NEW.arff")
```
...
write.arff(sars2_g, file = "predict_RN7SK_guanine_amp_NEW.arff")

tx <- readLines("predict_RN7SK_guanine_amp_NEW.arff")
tx_line15 <- gsub(pattern = "'\\?'", replace = "none,Gm", x = tx[15])
tx2 <- tx
tx2[15] <- tx_line15
tx3 <- gsub(pattern = "'", replace = "", x = tx2)

writeLines(tx3, "predict_RN7SK_guanine_amp_NEW.arff")
```
...
write.arff(sars2_a, file = "predict_RN7SK_adenines_amp_NEW.arff")

tx <- readLines("predict_RN7SK_adenines_amp_NEW.arff")
tx_line15 <- gsub(pattern = "'\\?'", replace = "none,Am", x = tx[15])
tx2 <- tx
tx2[15] <- tx_line15
tx3 <- gsub(pattern = "'", replace = "", x = tx2)

writeLines(tx3, "predict_RN7SK_adenines_amp_NEW.arff")
```
