...
if (length(args)<1){
  ...
  cat("    cytidine_predictions.arff          - WEKA format feature file with classifications for C\n")
  cat("    guanosine_predictions.arff         - WEKA format feature file with classifications for G\n")
  cat("    uridine_predictions.arff           - WEKA format feature file with classifications for U\n")
